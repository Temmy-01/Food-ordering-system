                ...
                <tr>
                    ...
                    <td>
                        <select name="status" >
                            ...
                            <option <?php if($status=='On Delivery'){echo "selected";} ?> value="On Delivery">On delievery</option>
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                if($res2 ==true){
                    ...
                    header('location:'.SITEURL.'admin/manage-orderp.php');
                }
            }
